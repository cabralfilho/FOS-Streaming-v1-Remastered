...
packages_install(){
    ...
    apt-get install -y --force-yes libpthread-stubs*-dev > /dev/null 2>&1
    ...
    apt-get install -y --force-yes libsasl*-dev > /dev/null 2>&1
    apt-get install -y --force-yes libsasl*-modules > /dev/null 2>&1
    ...
    apt-get install -y --force-yes libsensors*-dev > /dev/null 2>&1
    ...
    apt-get install -y --force-yes libsqlite*-dev > /dev/null 2>&1
    ...
    apt-get install -y --force-yes libtasn*-3-dev > /dev/null 2>&1
    apt-get install -y --force-yes libtasn*-6-dev > /dev/null 2>&1
    ...
    apt-get install -y --force-yes libtiff*-dev > /dev/null 2>&1
